...
var
	...
	CAddressModel = __webpack_require__(/*! modules/CoreWebclient/js/models/CAddressModel.js */ "vsHO")
;
...
var
	...
	CFetcherModel = __webpack_require__(/*! modules/MailWebclient/js/models/CFetcherModel.js */ "P7A8"),
	CAliasModel = __webpack_require__(/*! modules/MailWebclient/js/models/CAliasModel.js */ "U1iB"),
...
const Settings = __webpack_require__(/*! modules/MailWebclient/js/Settings.js */ "oFXy")
...
module.exports = {
  ...
  send: function (sMethod, oParameters, fResponseHandler, oContext) {
    var MailCache = __webpack_require__(/*! modules/MailWebclient/js/Cache.js */ "F0Fd"),
...
const CreaUtils = __webpack_require__(/*! modules/MailWebclient/js/utils/Crea.js */ "/5GA")
...
var
	...
	Ajax = __webpack_require__(/*! modules/MailWebclient/js/Ajax.js */ "QaEg"),
	MessagesDictionary = __webpack_require__(/*! modules/MailWebclient/js/MessagesDictionary.js */ "Yv0F"),
	Prefetcher = null,
	Settings = __webpack_require__(/*! modules/MailWebclient/js/Settings.js */ "oFXy"),
	
	CFolderModel = __webpack_require__(/*! modules/MailWebclient/js/models/CFolderModel.js */ "dik8"),
	CFolderListModel = __webpack_require__(/*! modules/MailWebclient/js/models/CFolderListModel.js */ "EnpP"),
	CUidListModel = __webpack_require__(/*! modules/MailWebclient/js/models/CUidListModel.js */ "LgRS"),
...
{
	Prefetcher = __webpack_require__(/*! modules/MailWebclient/js/Prefetcher.js */ "uC+w");
};
...
CMailCache.prototype.closeComposesWithDraftUids = function (aUids)
{
	...
	{
		var ComposeUtils = __webpack_require__(/*! modules/MailWebclient/js/utils/Compose.js */ "B5X4");
...
CAttachmentModel.prototype.copyProperties = function (oSource)
{
	...
	App.broadcastEvent('MailWebclient::CopyFileProperties::after', { file: this, source: oSource });
};
...
CAttachmentModel.prototype.onGetMessageResponse = function (oResult, oRequest)
{
	var
		...
		CMessageModel = __webpack_require__(/*! modules/MailWebclient/js/models/CMessageModel.js */ "XbbE"),
...
CFolderModel.prototype.openEditFolderPopup = function ()
{
	...
	{
		var EditFolderPopup = __webpack_require__(/*! modules/MailWebclient/js/popups/EditFolderPopup.js */ "H6Dt");
...
var
	...
	CAddressListModel = __webpack_require__(/*! modules/CoreWebclient/js/models/CAddressListModel.js */ "a6uM"),
	CDateModel = __webpack_require__(/*! modules/CoreWebclient/js/models/CDateModel.js */ "jNBr"),

	MessageUtils = __webpack_require__(/*! modules/MailWebclient/js/utils/Message.js */ "uLes"),
...
var
	...
	ConfirmAnotherMessageComposedPopup = __webpack_require__(/*! modules/MailWebclient/js/popups/ConfirmAnotherMessageComposedPopup.js */ "SDbG"),
...
var
	App = __webpack_require__(/*! modules/CoreWebclient/js/App.js */ "9kOp"),
	ComposeUtils = (App.isMobile() || App.isNewTab()) ? __webpack_require__(/*! modules/MailWebclient/js/utils/ScreenCompose.js */ "RUlD") : __webpack_require__(/*! modules/MailWebclient/js/utils/PopupCompose.js */ "9+aL")
;
...
const
  ...
  CHtmlEditorView = __webpack_require__(/*! modules/MailWebclient/js/views/CHtmlEditorView.js */ "HCQl")
;
...
{
	return __webpack_require__(/*! modules/MailWebclient/js/popups/ComposePopup.js */ "/N4H");
}
...
const MailCache = __webpack_require__(/*! modules/MailWebclient/js/Cache.js */ "F0Fd"),
  Settings = __webpack_require__(/*! modules/MailWebclient/js/Settings.js */ "oFXy")
...
const AddressUtils = __webpack_require__(/*! modules/CoreWebclient/js/utils/Address.js */ "kG5I"),
  FilesUtils = __webpack_require__(/*! modules/CoreWebclient/js/utils/Files.js */ "teN/"),
  TextUtils = __webpack_require__(/*! modules/CoreWebclient/js/utils/Text.js */ "H20a"),
  Types = __webpack_require__(/*! modules/CoreWebclient/js/utils/Types.js */ "KC/L"),
  Utils = __webpack_require__(/*! modules/CoreWebclient/js/utils/Common.js */ "REt5"),
  App = __webpack_require__(/*! modules/CoreWebclient/js/App.js */ "9kOp"),
...
const SelectFilesPopup = ModulesManager.run('FilesWebclient', 'getSelectFilesPopup')

const LinksUtils = __webpack_require__(/*! modules/MailWebclient/js/utils/Links.js */ "CPab"),
  SendingUtils = __webpack_require__(/*! modules/MailWebclient/js/utils/Sending.js */ "F0/K"),
  ...
  SenderSelector = __webpack_require__(/*! modules/MailWebclient/js/SenderSelector.js */ "ALdR"),
  Settings = __webpack_require__(/*! modules/MailWebclient/js/Settings.js */ "oFXy"),
  CMessageModel = __webpack_require__(/*! modules/MailWebclient/js/models/CMessageModel.js */ "XbbE"),
  CAttachmentModel = __webpack_require__(/*! modules/MailWebclient/js/models/CAttachmentModel.js */ "TGY0"),
  CComposeViewAutoEncrypt = __webpack_require__(/*! modules/MailWebclient/js/views/CComposeViewAutoEncrypt.js */ "WX6o")

const CHtmlEditorView = EditorUtils.getCHtmlEditorView(),
  MainTab = App.isNewTab() && window.opener && window.opener.MainTabMailMethods,
  $html = $('html')
/**
 * @constructor
...
function CComposeView() {
  ...
  this.disableHeadersEdit = ko.computed(function () {
    ...
    _.each(this.allControllers(), function (oController) {
      bDisableHeadersEdit =
        bDisableHeadersEdit || (!!oController.disableHeadersEdit && oController.disableHeadersEdit())
    })
  ...
  if (Settings.AllowAutosaveInDrafts && Settings.AutoSaveIntervalSeconds > 0) {
    ...
    ko.computed(function () {
      var bAllowAutosave =
        this.draftFolderIsAvailable() &&
        this.composeShown() &&
        !this.sending() &&
        !this.saving() &&
        !this.disableAutosave() &&
        !MailCache.disableComposeAutosave()
      _.each(this.allControllers(), function (oController) {
      ...
      if (bAllowAutosave) {
        this.iAutosaveInterval = window.setInterval(
          _.bind(this.executeSave, this, true),
  ...
  this.saveAndCloseTooltip = ko.computed(function () {
    return this.draftFolderIsAvailable() && this.hasUnsavedChanges()
      ? TextUtils.i18n('MAILWEBCLIENT/ACTION_SAVE_CLOSE')
      : TextUtils.i18n('MAILWEBCLIENT/ACTION_CLOSE')
  }, this)
...
CComposeView.prototype.initInputosaurus = function (koAddrDom, koAddr, koLockAddr, sFocusedField) {
  if (koAddrDom() && $(koAddrDom()).length > 0) {
    const suggestParameters = {
      ...
      autoCompleteSource = ModulesManager.run('ContactsWebclient', 'getSuggestionsAutocompleteCallback', [
        suggestParameters,
      ])
    var oOptions = {
      width: 'auto',
      ...
      autoCompleteDeleteItem:
        ModulesManager.run('ContactsWebclient', 'getSuggestionsAutocompleteDeleteHandler') || function () {},
    ...
    case 'data':
      ...
      if (oData) {
        ...
        if (oData.replyToMessage) {
          var oReplyData = SendingUtils.getReplyDataFromMessage(
            oData.replyToMessage,
            Enums.ReplyType.Reply,
...
CComposeView.prototype.onHide = function () {
  ...
  $html
    .removeClass('screen-compose')
    .removeClass('screen-compose-cc')
    .removeClass('screen-compose-bcc')
    .removeClass('screen-compose-attachments')
  ...
  if (oMessage === null) {
    ...
    switch (this.routeType()) {
      ...
      case Enums.ReplyType.ReplyAll:
        ...
        oReplyData = SendingUtils.getReplyDataFromMessage(
          oMessage,
          this.routeType(),
...
CComposeView.prototype.setDataFromMessage = function (oMessage) {
  var sTextBody = '',
    oFetcherOrIdentity = SendingUtils.getFirstFetcherOrIdentityByRecipientsOrDefault(
      oMessage.oFrom.aCollection,
      oMessage.accountId()
    )
  ...
  this.triggerToolbarControllersAfterPopulatingMessage(
    bDraft,
    oMessage.isPlain(),
    oMessage.textRaw(),
    oMessage.sensitivity()
  )
}

CComposeView.prototype.triggerToolbarControllersAfterPopulatingMessage = function (
  bDraft,
  bPlain,
  sRawText,
  iSensitivity
...
CComposeView.prototype.requestAttachmentsTempName = function () {
  ...
  if (aHash.length > 0) {
    this.messageUploadAttachmentsStarted(true)
    Ajax.send(
      'SaveAttachmentsAsTempFiles',
      { AccountID: this.senderAccountId(), Attachments: aHash },
      this.onMessageUploadAttachmentsResponse,
      this
    )
  }
}
...
CComposeView.prototype.getSendSaveParameters = function (bRemoveSignatureAnchor, bSaveTemplate) {
  ...
  oParameters = {
    ...
    IdentityID:
      this.selectedFetcherOrIdentity() && this.selectedFetcherOrIdentity().IDENTITY
        ? this.selectedFetcherOrIdentity().id()
        : '',
    AliasID:
      this.selectedFetcherOrIdentity() && this.selectedFetcherOrIdentity().ALIAS
        ? this.selectedFetcherOrIdentity().id()
        : '',
    FetcherID:
      this.selectedFetcherOrIdentity() && this.selectedFetcherOrIdentity().FETCHER
        ? this.selectedFetcherOrIdentity().id()
        : '',
    ...
    case 'SaveMessage':
      if (
        ...
        if (this.composeShown() && this instanceof CComposeView) {
          ...
          Routing.replaceHashDirectly(
            LinksUtils.getComposeFromMessage(
              'drafts',
              MailCache.currentAccountId(),
              oParameters.DraftFolder,
              this.templateUid()
            )
          )
        }
...
CComposeView.prototype.executeSend = function (mParam) {
  var bCancelSend = false,
    fContinueSending = _.bind(function () {
      ...
      SendingUtils.send(
        'SendMessage',
        this.getSendSaveParameters(true),
        true,
...
CComposeView.prototype.executeSave = function (bAutosave, bWaitResponse, bSaveTemplate) {
  ...
  var fOnSaveMessageResponse = bWaitResponse
      ? this.onSendOrSaveMessageResponse
      : SendingUtils.onSendOrSaveMessageResponse,
    ...
    fSave = _.bind(function (bSave) {
      if (bSave) {
        ...
        SendingUtils.send(
          'SaveMessage',
          this.getSendSaveParameters(false, bSaveTemplate),
          !bAutosave,
          fOnSaveMessageResponse,
          oContext
        )
      }
    }, this),
...
CComposeView.prototype.openInNewWindow = function () {
  ...
  if (this.draftUid().length > 0 && !this.isChanged()) {
    sHash = Routing.buildHashFromArray(
      LinksUtils.getComposeFromMessage(
        'drafts',
        MailCache.currentAccountId(),
        MailCache.folderList().draftsFolderFullName(),
        this.draftUid(),
        true
      )
    )
...
CComposeView.prototype.registerToolbarController = function (oController) {
  ...
  if (bAllowRegister) {
    ...
    this.toolbarControllers(
      _.sortBy(this.toolbarControllers(), function (oContr) {
...
const Popups = __webpack_require__(/*! modules/CoreWebclient/js/Popups.js */ "oUN1"),
  AlertPopup = __webpack_require__(/*! modules/CoreWebclient/js/popups/AlertPopup.js */ "hT1I"),
  ConfirmPopup = __webpack_require__(/*! modules/CoreWebclient/js/popups/ConfirmPopup.js */ "XeMN")

const CAttachmentModel = __webpack_require__(/*! modules/MailWebclient/js/models/CAttachmentModel.js */ "TGY0"),
  CColorPickerView = __webpack_require__(/*! modules/MailWebclient/js/views/CColorPickerView.js */ "Alnx"),
  CCrea = __webpack_require__(/*! modules/MailWebclient/js/CCrea.js */ "Qskt"),
  MailCache = __webpack_require__(/*! modules/MailWebclient/js/Cache.js */ "F0Fd"),
  Settings = __webpack_require__(/*! modules/MailWebclient/js/Settings.js */ "oFXy"),
  TemplatesUtils = __webpack_require__(/*! modules/MailWebclient/js/utils/Templates.js */ "lYJ2"),
  sourceEditor = __webpack_require__(/*! modules/MailWebclient/js/views/html-editor/SourceEditor.js */ "2cmR")
...
function CHtmlEditorView(bInsertImageAsBase64, bAllowComposePlainText, oParent) {
  ...
  this.sourceCodeButtonText = ko.computed(() => {
    return this.editSourceMode()
      ? TextUtils.i18n('MAILWEBCLIENT/ACTION_EDIT_HTML_PREVIEW')
      : TextUtils.i18n('MAILWEBCLIENT/ACTION_EDIT_HTML_SOURCE_CODE')
  })
  ...
  this.oFontColorPickerView = new CColorPickerView(
    TextUtils.i18n('MAILWEBCLIENT/LABEL_TEXT_COLOR'),
    this.setTextColorFromPopup,
    this
  )
  this.oBackColorPickerView = new CColorPickerView(
    TextUtils.i18n('MAILWEBCLIENT/LABEL_BACKGROUND_COLOR'),
...
const
	codemirror = __webpack_require__(/*! codemirror */ "VJBI"),

...
module.exports = function (oAppData) {
	...
	{
		var Settings = __webpack_require__(/*! modules/SettingsWebclient/js/Settings.js */ "ckPu");
		...
		return {
			getScreens: function () {
				...
				oScreens[Settings.HashModuleName] = function () {
					return __webpack_require__(/*! modules/SettingsWebclient/js/views/SettingsView.js */ "7bsT");
				};
				return oScreens;
			},
			...
			registerSettingsTab: function (fGetTabView, sTabName, sTabTitle) {
				var SettingsView = __webpack_require__(/*! modules/SettingsWebclient/js/views/SettingsView.js */ "7bsT");
			...
			getAbstractSettingsFormViewClass: function () {
				return __webpack_require__(/*! modules/SettingsWebclient/js/views/CAbstractSettingsFormView.js */ "/wNe");
			},
...
var
	...
	Settings = __webpack_require__(/*! modules/SettingsWebclient/js/Settings.js */ "ckPu"),
